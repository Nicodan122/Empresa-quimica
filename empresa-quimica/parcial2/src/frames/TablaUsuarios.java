...
public class TablaUsuarios extends JFrame {
	...
	public TablaUsuarios() {
       ...
       Usuario seleccionado = new Usuario();
        ...
        String[] columnNames = {"ID", "Nombre", "Contra","Rol"};
        ...
        btnEliminar.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		...
        		if (seleccionado.getIdUsuario()!=0) { //cambie .getId() x getIdUsuario()
					
        			controlador.deleteUser(seleccionado.getIdUsuario());
        ...
        Editar.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		...
        		if (seleccionado.getIdUsuario()!=0) {
            ...
            public void valueChanged(ListSelectionEvent e) {
                if (!e.getValueIsAdjusting()) {
                    ...
                    if (selectedRow != -1) {
                        ...
                        String contra = (String) table.getValueAt(selectedRow, 2);
                        String rol = (String) table.getValueAt(selectedRow, 3);
                        
                       // int rol = (int) table.getValueAt(selectedRow, 3);
                        
                        elemento.setText("Seleccionado: ID=" + id + ", Nombre de Usuario=" + nombre + ", Contra=" + contra + "Rol=" + rol );
                        seleccionado.setContra(contra);
                        seleccionado.setNombre(nombre);
                        seleccionado.setIdUsuario(id);
